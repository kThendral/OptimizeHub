...
export default function AlgorithmSelector({ onHome }) {
    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        {onHome && (
          <button
            onClick={onHome}
            className="flex items-center gap-2 px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-100 hover:text-gray-800 transition-all duration-200"
            title="Back to Home"
          >
